...
const styles = StyleSheet.create({
  ...
  card: { marginHorizontal: spacing.screen, marginTop: spacing.lg, borderRadius: radius.control, backgroundColor: colors.surfaceWarm, overflow: 'hidden' },
  row: { minHeight: 74, padding: spacing.md, flexDirection: 'row', alignItems: 'center', gap: spacing.sm },
  divider: { borderBottomWidth: 1, borderBottomColor: colors.white },
  bell: { width: 36, height: 36, borderRadius: 18, backgroundColor: colors.primarySoft, alignItems: 'center', justifyContent: 'center' },
  bellRead: { backgroundColor: colors.white },
